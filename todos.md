...
- [x] Verify: test queries from [client-brief](docs/client-brief.md) return relevant chunks (manual or scripted)
...
- [x] Verify against [client-brief example questions](docs/client-brief.md#example-analyst-questions):
