...
flowchart TD
    ...
    E -->|OpenAIOllama embedding| VEC[Query vector]
...
| `retrieval_fts_keyword_model` | `"qwen3"` | Small model for FTS keyword extraction |
...
| `ollama_embedding_model` | `"nomic-embed-text"` | Model used for live query embeddings |
| `ollama_embedding_dimensions` | `768` | Embedding width; must match ingested chunk vectors |
