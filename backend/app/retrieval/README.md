...
flowchart TD
    ...
    E -->|Google Gen AI embedding| VEC[Query vector]
...
| `genai_embedding_model` | `"text-embedding-004"` | Model used for live query embeddings |
| `genai_embedding_dimensions` | `768` | Embedding width; must match ingested chunk vectors |
